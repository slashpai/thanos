...
PROMETHEUS_ARRAY := $(GOBIN)/prometheus-v1.8.2-0.20200724121523-657ba532e42f $(GOBIN)/prometheus-v1.8.2-0.20210331101223-3cafc58827d1
$(PROMETHEUS_ARRAY): $(BINGO_DIR)/prometheus.1.mod $(BINGO_DIR)/prometheus.2.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
